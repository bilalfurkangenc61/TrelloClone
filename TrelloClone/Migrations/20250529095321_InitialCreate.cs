        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardAssignments_AspNetUsers_AssignedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardAttachments_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardSprints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CardSprints_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CardSprints_Sprints_SprintId",
                        column: x => x.SprintId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistItems_AspNetUsers_CompletedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardSprints_CardId_SprintId",
                table: "CardSprints",
                columns: new[] { "CardId", "SprintId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CardSprints_SprintId",
                table: "CardSprints",
                column: "SprintId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistItems_CompletedByUserId",
                table: "ChecklistItems",
