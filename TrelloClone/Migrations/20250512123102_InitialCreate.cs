        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxMembersPerBoard = table.Column<int>(type: "int", nullable: false),
                    AllowAttachments = table.Column<bool>(type: "bit", nullable: false),
                    MaxAttachmentSize = table.Column<long>(type: "bigint", nullable: false),
                    AllowCustomBackgrounds = table.Column<bool>(type: "bit", nullable: false),
                    AdvancedReporting = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardAttachments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Subscriptions",
                columns: new[] { "Id", "AdvancedReporting", "AllowAttachments", "AllowCustomBackgrounds", "Description", "MaxAttachmentSize", "MaxBoards", "MaxMembersPerBoard", "Name", "Price" },
                values: new object[,]
                {
                    { 1, false, false, false, "Basic Kanban functionality for individuals", 0L, 3, 5, "Free", 0m },
                    { 2, false, true, true, "Enhanced features for small teams", 10485760L, 10, 15, "Basic", 9.99m },
                    { 3, true, true, true, "Full-featured solution for organizations", 104857600L, 100, 50, "Premium", 24.99m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardAttachments_UserId",
                table: "CardAttachments",
                column: "UserId");
